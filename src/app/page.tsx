  ...
  return (
    <div className="w-full flex flex-col items-center px-4 py-8">
      <div className="max-w-6xl w-full">
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center gap-4">
                <div className="w-16 h-16 bg-blue-100 rounded-lg flex flex-col items-center justify-center hover:bg-blue-200 transition-colors">
                  ...
                  <span className="text-xs font-bold text-blue-600">Python</span>
                </div>
                <div className="w-16 h-16 bg-yellow-100 rounded-lg flex flex-col items-center justify-center hover:bg-yellow-200 transition-colors">
                  ...
                  <span className="text-xs font-bold text-yellow-600">JavaScript</span>
                </div>
              </div>
            </div>
            <div className="text-center">
              ...
              <div className="flex justify-center gap-4">
                ...
                <div className="w-16 h-16 bg-green-100 rounded-lg flex flex-col items-center justify-center hover:bg-green-200 transition-colors">
                  ...
                  <span className="text-xs font-bold text-green-600">FastAPI</span>
                </div>
                <div className="w-16 h-16 bg-emerald-100 rounded-lg flex flex-col items-center justify-center hover:bg-emerald-200 transition-colors">
                  ...
                  <span className="text-xs font-bold text-emerald-600">Express</span>
                </div>
              </div>
            </div>
            <div className="text-center">
              <h3 className="text-xl font-semibold mb-4">클라우드 & 데브옵스</h3>
              <div className="flex justify-center gap-4">
                ...
                <div className="w-16 h-16 bg-blue-100 rounded-lg flex flex-col items-center justify-center hover:bg-blue-200 transition-colors">
                  ...
                  <span className="text-xs font-bold text-blue-600">Docker</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center gap-4">
                ...
                <div className="w-16 h-16 bg-green-100 rounded-lg flex flex-col items-center justify-center hover:bg-green-200 transition-colors">
                  ...
                  <span className="text-xs font-bold text-green-600">MongoDB</span>
                </div>
              </div>
            </div>
            <div className="text-center">
              <h3 className="text-xl font-semibold mb-4">운영체제 / 개발 환경</h3>
              <div className="flex justify-center gap-4">
                <div className="w-16 h-16 bg-slate-100 rounded-lg flex flex-col items-center justify-center hover:bg-slate-200 transition-colors">
                  ...
                  <span className="text-xs font-bold text-slate-600">Linux</span>
                </div>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-purple-500 pl-4">
              ...
              <p className="font-semibold">습지와 온도 상관관계 분석 웹페이지 개발 및 데모데이 우수 운영</p>
              <p className="text-sm text-gray-600">해동빌딩 스테이지</p>
            </div>
            <div className="border-l-4 border-purple-500 pl-4">
              <div className="flex items-center gap-2 mb-1">
                <Calendar className="w-4 h-4" />
                <span className="text-sm text-gray-600">2024.12.20 ~ 2024.12.24</span>
              </div>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-yellow-500 pl-4">
              ...
              <p className="font-semibold">2025 용산구 공공데이터 활용 스마트도시 아이디어 공모전 우수상</p>
            ...
            <div className="border-l-4 border-yellow-500 pl-4">
              ...
              <p className="font-semibold">공간정보 웹/앱 활용 경진대회 최우수상</p>
        ...
        {/* 블로그 포스트 섹션 */}
        <section>
          <h2 className="text-3xl font-bold text-center mb-8">최근 블로그 포스트</h2>
          {posts.length > 0 ? (
                ...
                >
                  ...
                  <div className="p-4">
                    <h3 className="text-xl font-bold mb-2">
                      <Link href={`/posts/${post.slug}`} className="hover:text-purple-600 transition-colors">
                        {post.metadata.title || post.slug}
                      </Link>
                    </h3>
                    <p className="text-gray-600 mb-4">{post.metadata.description || "설명이 없습니다."}</p>
                    <Link href={`/posts/${post.slug}`} className="text-purple-500 hover:underline font-medium">
                      자세히 보기 →
                    </Link>
                  </div>
                </div>
            ...
            <div className="text-center text-gray-500">
              ...
              <p className="text-sm mt-2">src/content 디렉토리에 MDX 파일을 추가해주세요.</p>
            </div>
          )}
        </section>
      </div>
