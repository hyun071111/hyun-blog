...
<img src="/img/JWT.png" alt="URI 설계 개념" style={{ width: 'auto', height: 'auto' }} />
...
## 동작 방식
<img src="/img/JWT-동작방식.png" alt="URI 설계 개념" style={{ width: 'auto', height: 'auto' }} />
<br />
> 참고 자료:
> [REST API 설계 원칙](https://ivory-room.tistory.com/88)